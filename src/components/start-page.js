  ...
  if (!leaderboardMode) {
      return (
        <div className = "Start">
          ...
          <p>Memory is the card game where you try to flip 2 of the same card! Each correct pair gives you 2 extra seconds on the clock, but be careful since each wrong pair takes a second away! You also get time added on for each level passed!</p>
        </div>
    )
  } else {
